    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
          ...
          {SPORTS.map((sport) => (
            <TouchableOpacity
              ...
              style={[
                ...
                !selectedSport !== sport && { backgroundColor: colors.border }
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  !selectedSport !== sport && { color: colors.textSecondary }
                ]}
              >
                {sport}
              </Text>
      ...
      <FlatList
        ...
        renderItem={({ item: league }) => (
          <View>
            <Text style={[styles.leagueTitle, { color: colors.textSecondary }]}>{league.toUpperCase()}</Text>
              ...
              >
                <View style={styles.teamBox}>
                  {badges[event.homeTeam] ? (
                    ...
                    <View style={[styles.badgePlaceholder, { backgroundColor: colors.border }]}>
                      <Text style={[styles.badgeText, { color: colors.textSecondary }]}>
                        {event.homeTeam.substring(0, 3).toUpperCase()}
                      </Text>
                    </View>
                  )}
                  <Text style={[styles.teamName, { color: colors.text }]}>{event.homeTeam}</Text>
                </View>
                ...
                <View style={styles.scoreBox}>
                  ...
                  <Text style={[styles.status, { color: colors.textSecondary }]}>{event.status}</Text>
                </View>
                ...
                <View style={styles.teamBox}>
                  ...
                  <Text style={[styles.teamName, { color: colors.text }]}>{event.awayTeam}</Text>
                </View>
              </TouchableOpacity>
            ))}
          </View>
